...
cd /source/qt5 && ./configure -v -developer-build -opensource -nomake examples -nomake tests -confirm-license -opengl desktop -prefix /opt/usr && make  -j8 && make install && rm -rfv $SOURCES/qt5
rm -rfv /source/qt5
