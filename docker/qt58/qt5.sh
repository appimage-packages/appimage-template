...
cd /source && git clone git://code.qt.io/qt/qt5.git && cd qt5 && git checkout 5.8
...
cd /source/qt5 && ./configure -v -developer-build -opensource -nomake examples -nomake tests -confirm-license -prefix /opt/usr && make  -j8 && make install && rm -rfv $SOURCES/qt5
rm -rfv /source/qt5
